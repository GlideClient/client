...
public enum TranslateText {
	...
	UI_BLUR("text.ui.blur"), BLUR_STRENGTH("text.blur.strength"), MC_FONT("text.hud.mcfont"), CHANGELOG("text.changelog"), NEWS("text.news"), SEARCH("text.search"), SUPERHEROFX_NAME("text.superherofx.name"), SUPERHEROFX_DESCRIPTION("text.superherofx.description"), PANO("text.panorama"), EMPTY_STRING("empty.string"), SHIMMER("text.shimmer"), NORTHEN_WISPERS("text.northenwispers"), ABOUT("text.about"), ABOUT_DESCRIPTION("text.about.description");
