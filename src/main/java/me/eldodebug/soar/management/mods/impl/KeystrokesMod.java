...
public class KeystrokesMod extends HUDMod {
	...
	public void onRender2D(EventNVG event) {
		...
		if(!unmarkedSetting.isToggled()) {
			this.drawCenteredText(Keyboard.getKeyName(mc.gameSettings.keyBindForward.getKeyCode()), 32 + (28 / 2), (28 / 2) + 1, 12, getHudFont(1));
			this.drawCenteredText(Keyboard.getKeyName(mc.gameSettings.keyBindLeft.getKeyCode()), 0 + (28 / 2), 32 + (28 / 2) + 1, 12, getHudFont(1));
			this.drawCenteredText(Keyboard.getKeyName(mc.gameSettings.keyBindBack.getKeyCode()), 32 + (28 / 2), 32 + (28 / 2) + 1, 12, getHudFont(1));
			this.drawCenteredText(Keyboard.getKeyName(mc.gameSettings.keyBindRight.getKeyCode()), 64 + (28 / 2), 32 + (28 / 2) + 1, 12, getHudFont(1));
		}
