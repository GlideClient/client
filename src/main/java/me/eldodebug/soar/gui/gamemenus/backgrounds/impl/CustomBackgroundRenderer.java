...
public class CustomBackgroundRenderer extends AbstractBackground {
    ...
    public void draw(ScaledResolution sr, Glide instance, NanoVGManager nvg, float partialTicks){
        ...
        me.eldodebug.soar.management.profile.mainmenu.impl.CustomBackground bg = (me.eldodebug.soar.management.profile.mainmenu.impl.CustomBackground) currentBackground;
